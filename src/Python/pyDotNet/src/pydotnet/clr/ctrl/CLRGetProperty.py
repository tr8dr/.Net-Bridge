...
class CLRGetProperty (CLRMessage):
    """
    Class for get property on object
    """

    def __init__(self, objectId: int = 0, property: str = ""):
        super().__init__ (CLRMessage.TypeGetProperty, (objectId, property))
