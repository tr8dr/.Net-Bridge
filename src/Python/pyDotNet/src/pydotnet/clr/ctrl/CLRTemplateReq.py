...
class CLRTemplateReq (CLRMessage):
    """
    Class for getting information about a class
    """

    def __init__(self, classname: str = ""):
        super().__init__ (CLRMessage.TypeTemplateReq, classname)
