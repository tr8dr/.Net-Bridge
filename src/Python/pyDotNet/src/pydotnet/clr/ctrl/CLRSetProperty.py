...
class CLRSetProperty (CLRMessage):
    """
    Class for setting property on object
    """

    def __init__(self, objectId: int = 0, property: str = "", value = None):
        super().__init__ (CLRMessage.TypeSetProperty, (objectId, property, value))
