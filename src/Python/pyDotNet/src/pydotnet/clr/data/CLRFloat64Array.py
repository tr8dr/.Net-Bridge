...
class CLRFloat64Array (CLRMessage):
    """
    Class for float64 arrays
    """

    def __init__(self, v = []):
        super().__init__ (CLRMessage.TypeFloat64Array, v)
    ...
    def serialize (self, sock: BinarySocketWriter):
        ...
        sock.writeFloat64Array(self.value)
    ...
    def deserialize (self, sock: BinarySocketReader):
        ...
        self.value = sock.readFloat64Array ()
