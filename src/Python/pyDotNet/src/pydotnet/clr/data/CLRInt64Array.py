...
class CLRInt64Array (CLRMessage):
    """
    Class for int64 arrays
    """

    def __init__(self, v = []):
        super().__init__ (CLRMessage.TypeInt64Array, v)
    ...
    def serialize (self, sock: BinarySocketWriter):
        ...
        sock.writeInt64Array(self.value)
    ...
    def deserialize (self, sock: BinarySocketReader):
        ...
        self.value = sock.readInt64Array ()
